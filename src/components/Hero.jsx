                ...
                <div className='hero'>
                    <div className="hero-content">
                        <div className='hero-text'>
                            ...
                            <p className='fs-250 op-200 margin-block-300'>With 3+ years of experience in web design and development, my true skill development began during my intership at Ant Cyber Engineering. This experience has porpelled my ongoing journey of learbing and constant improvement.
                            </p>
