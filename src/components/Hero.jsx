            ...
            <div id='Home' className='hero'>
                <div className="hero-content">
                    <div className='hero-text'>
                        <code className=''>Hello world - this is my portfolio page</code>
                        ...
                        <p className='fs-250 op-200 margin-block-200'>With 3+ years of experience in web design and development, my true skill development began during my intership at Ant Cyber Engineering. This experience has porpelled my ongoing journey of learbing and constant improvement.
                        </p>
                    ...
                    <div className={`resume-links ${resumeLinks ? "active" : ""}`}>
                        ...
                        <a href={resumeFile} target='_blank' className='button resume-link' data-type='white' download={"KwameDanso-resume.pdf"}>Download <MdOutlineFileDownload /></a>
                    </div>
